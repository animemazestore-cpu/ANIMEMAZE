      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="text-2xl font-extrabold tracking-wider bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
              AnimeMaze
            </Link>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <a href="https://www.instagram.com/animemaze.store" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link to="/shop?category=hoodies" className="hover:text-white transition-colors">Anime Hoodies</Link></li>
              <li><Link to="/shop?category=katanas" className="hover:text-white transition-colors">Display Katanas</Link></li>
          ...
          <div>
            ...
            {/* Payment Badge info */}
            <div className="mt-6 p-3 bg-surface border border-white/5 rounded-lg">
              <div className="flex items-center space-x-1.5 text-xs font-semibold text-secondary mb-1">
